...
- Air-gapped deployment → [environments/air-gapped.md](environments/air-gapped.md)
- Private cluster → [environments/private-cluster.md](environments/private-cluster.md)
- Firewall-restricted → [environments/firewall-restricted.md](environments/firewall-restricted.md)
- Multi-tenant → [environments/multi-tenant.md](environments/multi-tenant.md)
- Hybrid (cloud + on-prem) → [environments/hybrid.md](environments/hybrid.md)
