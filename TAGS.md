...
Use tags when you know the type of work you need, but not the exact guide name. The documentation site also indexes these terms through local search.

<div class="tag-list">
  <span class="tag-pill">discovery</span>
  <span class="tag-pill">poc</span>
  <span class="tag-pill">implementation</span>
...
- [Discovery](pre-sales/discovery.md)
...
- [Inherited Customer](engagements/inherited-customer.md)
...
- [Strategic Escalation](recovery/escalation.md)
- [Getting Unstuck](recovery/stuck.md)
- [Scope Creep](recovery/scope-creep.md)
- [Requesting Help](internal/requesting-help.md)
- [Customer Escalation Response](templates/customer/escalation-response.md)

## customer-facing

- [Start Here](START-HERE.md)
- [Pre-Sales Guides](pre-sales/discovery.md)
- [Implementation Guides](implementation/kickoff.md)
...
- [Post-Call Debrief](internal/post-call-debrief.md)
- [Status Updates](internal/status-updates.md)
- [Requesting Help](internal/requesting-help.md)
- [SE Handoff](internal/handoff-to-se.md)
