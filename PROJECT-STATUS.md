...
- ✅ `internal/post-call-debrief.md` - Post-call debrief format
...
### Templates (Extracted from Complete Drafts)
- ✅ `templates/discovery-questions.md` - Standalone discovery questions
- ✅ `templates/kickoff-agenda.md` - Kickoff call agenda
...
- ✅ Environment guides focus on operational guidance (not technical implementation)
